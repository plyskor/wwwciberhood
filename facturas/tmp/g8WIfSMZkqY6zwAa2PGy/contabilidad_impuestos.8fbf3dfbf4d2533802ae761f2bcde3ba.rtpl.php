            ...
            <table class="table table-hover">
               ...
               <form class="form" role="form" action ="<?php echo $fsc->url();?>" method="post">
                  ...
                  <tr>
                     ...
                     <td>
                        <input class="form-control" type="text" name="codsubcuentasop" value="<?php echo $value1->codsubcuentasop;?>" placeholder="<?php echo $fsc->codsubcuentasop;?>" autocomplete="off"/>
                     </td>
                     <td>
                        <input class="form-control" type="text" name="codsubcuentarep" value="<?php echo $value1->codsubcuentarep;?>" placeholder="<?php echo $fsc->codsubcuentarep;?>" autocomplete="off"/>
                     </td>
                     <td class="text-right">
                        <div class="btn-group">
               ...
               <form class="form" name="f_nuevo_impuesto" action="<?php echo $fsc->url();?>" method="post">
                  <tr class="info">
                     ...
                     <td><input class="form-control" type="text" name="descripcion" placeholder="Nuevo impuesto..." autocomplete="off"/></td>
                     ...
                     <td><input class="form-control" type="text" name="codsubcuentasop" placeholder="<?php echo $fsc->codsubcuentasop;?>" autocomplete="off"/></td>
                     <td><input class="form-control" type="text" name="codsubcuentarep" placeholder="<?php echo $fsc->codsubcuentarep;?>" autocomplete="off"/></td>
                     <td class="text-right">
