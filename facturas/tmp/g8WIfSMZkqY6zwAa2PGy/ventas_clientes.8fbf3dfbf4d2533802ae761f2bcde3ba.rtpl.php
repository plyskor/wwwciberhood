...
<script type="text/javascript">
   ...
   {
      bootbox.confirm({
         message: '¿Realmente desea eliminar el grupo '+cod+'?',
         title: '<b>Atención</b>',
                  ...
                  <div class="col-sm-2">
                     <div class="input-group">
                        ...
                        <select name="orden" class="form-control" onchange="this.form.submit()">
                           ...
                           <option value="cifnif ASC"<?php if( $fsc->orden=='cifnif ASC' ){ ?> selected=""<?php } ?>>Orden: <?php  echo FS_CIFNIF;?></option>
                           <option value="cifnif DESC"<?php if( $fsc->orden=='cifnif DESC' ){ ?> selected=""<?php } ?>>Orden: <?php  echo FS_CIFNIF;?> descendente</option>
                           <option value="fechaalta ASC"<?php if( $fsc->orden=='fechaalta ASC' ){ ?> selected=""<?php } ?>>Orden: fecha</option>
                           <option value="fechaalta DESC"<?php if( $fsc->orden=='fechaalta DESC' ){ ?> selected=""<?php } ?>>Orden: fecha descendente</option>
                        </select>
                     </div>
                  </div>
               </div>
         ...
         <table class="table table-hover">
            <thead>
               <tr>
                  ...
                  <th class="text-left">
                     <a href="<?php echo $fsc->tarifa->url();?>">
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <div class="form-group<?php if( $fsc->nuevocli_setup['nuevocli_cifnif_req'] ){ ?> has-warning<?php } ?>">
                  ...
                  <div class="col-sm-7">
                     <input type="text" name="cifnif" class="form-control" maxlength="20" autocomplete="off"<?php if( $fsc->nuevocli_setup['nuevocli_cifnif_req'] ){ ?> required=""<?php } ?>/>
