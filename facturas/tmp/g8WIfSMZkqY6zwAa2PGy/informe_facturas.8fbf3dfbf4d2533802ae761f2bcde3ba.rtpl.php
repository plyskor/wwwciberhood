...
<script type="text/javascript">
   ...
   function drawChart()
   {
      ...
      <?php $loop_var1=$fsc->stats_last_months(); $counter1=-1; if($loop_var1) foreach( $loop_var1 as $key1 => $value1 ){ $counter1++; ?>
         ...
         ['<?php echo $value1['month'];?>', <?php echo $value1['neto_cli'];?>, <?php echo $value1['neto_pro'];?>, <?php echo $value1['beneficios'];?>],
      <?php } ?>
      ...
      <?php $loop_var1=$fsc->stats_last_years(); $counter1=-1; if($loop_var1) foreach( $loop_var1 as $key1 => $value1 ){ $counter1++; ?>
         ...
         ['<?php echo $value1['year'];?>', <?php echo $value1['neto_cli'];?>, <?php echo $value1['neto_pro'];?>, <?php echo $value1['beneficios'];?>],
      <?php } ?>
      ...
      <div class="col-sm-12">
         <div class="panel panel-default">
            ...
            <div class="panel-body">
               <div id="chart_facturas_day" style="height: 250px;"></div>
               <p class="help-block">
                  Los valores son <b>netos</b>, es decir, sin impuestos.
   ...
   <div class="row">
      <div class="col-sm-12">
         <div class="panel panel-default">
            ...
            <div class="panel-body">
               <div id="chart_facturas_month" style="height: 350px;"></div>
               <p class="help-block">
                  Los valores son <b>netos</b>, es decir, sin impuestos.
   ...
   <div class="row">
      <div class="col-sm-12">
         <div class="panel panel-default">
            ...
            <div class="panel-body">
               <div id="chart_facturas_year" style="height: 350px;"></div>
               <p class="help-block">Los valores son <b>netos</b>, es decir, sin impuestos.</p>
            </div>
         </div>
      </div>
   </div>
...
<div class="container-fluid">
   ...
   <div class="row">
      <div class="col-sm-6">
         <div class="panel panel-default">
            <div class="panel-heading">
               <h3 class="panel-title">Compras por <?php  echo FS_SERIE;?></h3>
            </div>
            <div class="panel-body">
      ...
      <div class="col-sm-6">
         <div class="panel panel-default">
            <div class="panel-heading">
               <h3 class="panel-title">Ventas por <?php  echo FS_SERIE;?></h3>
            </div>
            <div class="panel-body">
...
<script type="text/javascript">
   ...
   function drawChart()
   {
      ...
      data2.addRows([
      <?php $loop_var1=$fsc->stats_last_operations('facturascli'); $counter1=-1; if($loop_var1) foreach( $loop_var1 as $key1 => $value1 ){ $counter1++; ?>
         ...
         <form name="listado_proveedor" action="<?php echo $fsc->url();?>&mostrar=compras" method="post" target="_blank" class="form">
            ...
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  ...
                  <div class="form-group">
                     <a href="<?php echo $fsc->almacen->url();?>" class="text-capitalize">Almacén</a>:
