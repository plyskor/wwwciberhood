      ...
      <div class="col-sm-12">
         <div class="page-header">
            ...
            <p class="help-block">
               ...
               en tiempo real, pero los que están tachados se generan vía
            ...
            <div class="panel panel-default">
               <div class="panel-heading">
                  <h3 class="panel-title">
                     <a data-toggle="collapse" data-parent="#accordion" href="#collapse_<?php echo $counter1;?>">
                        Ejercicio <?php echo $value1->nombre;?>
                           ...
                           <div class="row">
                              <div class="col-sm-2">
                                 <div class="form-group">
                                    Desde:
                                    <input type="text" name="desde" value="<?php echo $value1->fechainicio;?>" class="form-control datepicker" autocomplete="off"/>
                                 </div>
                              </div>
                              <div class="col-sm-2">
                                 <div class="form-group">
                                    Hasta:
                                    <input type="text" name="hasta" value="<?php echo $value1->fechafin;?>" class="form-control datepicker" autocomplete="off"/>
                                 </div>
                              </div>
                              <div class="col-sm-3">
                                 <div class="form-group">
