               ...
               <tr<?php if( !$value1['compatible'] ){ ?> class="danger"<?php }elseif( $value1['enabled'] ){ ?> class="success"<?php } ?>>
                  ...
                  <td class="text-right">
                     ...
                     <div class="btn-group">
                        ...
                        <a class="btn btn-sm btn-default" href="#" onclick="bootbox.alert({message: 'Le falta el archivo facturascripts.ini',title: '<b>Atención</b>'});">
      ...
      <div role="tabpanel" class="tab-pane" id="t_descargas">
         ...
         <div class="table-responsive">
            <table class="table table-hover">
               ...
               <tr<?php if( file_exists('plugins/'.$value1->nombre) ){ ?> class="warning"<?php }elseif( !$value1->estable ){ ?> class="danger"<?php }elseif( $value1->tipo=='gratis' ){ ?> class="success"<?php } ?>>
                  <td class="text-center" width='80'>
                     <?php if( $value1->imagen ){ ?>

                        <?php if( !$value1->zip_link ){ ?>

                        <a href="<?php echo $value1->link;?>" target="_blank" class="thumbnail">
            ...
            <div class="container-fluid" style="margin-top: 10px;">
               ...
               <div class="row bg-warning">
                  ...
                  <div class="col-md-2 col-sm-2">
                     <div class="form-group<?php if( $GLOBALS['config2']['foreign_keys']==0 ){ ?> has-warning<?php } ?>">
