   ...
   <div class="container-fluid">
      ...
      <div class="row">
         ...
         <div class="col-sm-4">
            <div class="form-group">
               <?php  echo FS_CIFNIF;?>:
               <input class="form-control" type="text" name="cifnif" value="<?php echo $fsc->empresa->cifnif;?>" maxlength="20" autocomplete="off"/>
               <p class="help-block">
...
<div class="container-fluid">
   ...
   <div class="row">
      <div class="col-sm-3">
         <a href="index.php?page=admin_home&download=argentina#plugins" class="btn btn-sm btn-block btn-default">
            <span class="glyphicon glyphicon-download-alt"></span>&nbsp; Argentina
         </a>
         <br/>
      </div>
      <div class="col-sm-3">
         <a href="index.php?page=admin_home&download=chile#plugins" class="btn btn-sm btn-block btn-default">
            <span class="glyphicon glyphicon-download-alt"></span>&nbsp; Chile
         </a>
         <br/>
      </div>
      <div class="col-sm-3">
         <a href="index.php?page=admin_home&download=colombia#plugins" class="btn btn-sm btn-block btn-default">
            <span class="glyphicon glyphicon-download-alt"></span>&nbsp; Colombia
         </a>
         <br/>
      </div>
      <div class="col-sm-3">
      ...
      <div class="col-sm-3">
         <a href="index.php?page=admin_home&download=panama#plugins" class="btn btn-sm btn-block btn-default">
            <span class="glyphicon glyphicon-download-alt"></span>&nbsp; Panamá
         </a>
         <br/>
      </div>
      <div class="col-sm-3">
         <a href="index.php?page=admin_home&download=peru#plugins" class="btn btn-sm btn-block btn-default">
            <span class="glyphicon glyphicon-download-alt"></span>&nbsp; Perú
         </a>
         <br/>
      </div>
      <div class="col-sm-3">
         <a href="index.php?page=admin_home&download=republica_dominicana#plugins" class="btn btn-sm btn-block btn-default">
            <span class="glyphicon glyphicon-download-alt"></span>&nbsp; Rep. Dominicana
         </a>
         <br/>
      </div>
      <div class="col-sm-3">
         <a href="index.php?page=admin_home&download=venezuela#plugins" class="btn btn-sm btn-block btn-default">
            <span class="glyphicon glyphicon-download-alt"></span>&nbsp; Venezuela
         </a>
         <br/>
      </div>
   </div>
   ...
   <div class="row">
      ...
      <div class="col-sm-3">
         <a href="https://www.facturascripts.com/documentacion" target="_blank" class="btn btn-block btn-default">
      ...
      <div class="col-sm-3">
         <a href="https://www.facturascripts.com/plugin/import_export_csv" target="_blank" class="btn btn-block btn-default">
